...
$artifact = Join-Path $runs 'TASK-0024-J12-intrabrain-relations-regression-webview2.json'
$abandoned = Join-Path $runs 'TASK-0024-J12-intrabrain-relations-regression-webview2-abandon.json'
