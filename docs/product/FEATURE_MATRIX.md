...
| F-013 | Panneau latéral | Masquer/afficher sans perte | Panneau fixe | App.tsx:358 | Commande et persistance manquent | P1 | 5 | PROPOSED | État conservé au redémarrage | `ULTÉRIEUR` |
...
| F-017 | Relations transversales | Provenance explicite, jamais inventée | Aucun modèle observé | domain.rs | Manquant | P1 | 5 | PROPOSED | Chaque relation expose type et provenance | `ULTÉRIEUR` |
| F-018 | Mise en évidence | Accentuer liés, atténuer non liés | Sélection agrandit un point | TerrainMap.tsx:59 | Relations non prises en compte | P1 | 5 | PROPOSED | États visuels accessibles et testés | `ULTÉRIEUR` |
| F-019 | Relations entrantes/sortantes | Distinguer directions | Aucune preuve trouvée | domain.rs | Manquant | P2 | 5 | PROPOSED | Panneau et carte donnent mêmes comptes | `ULTÉRIEUR` |
